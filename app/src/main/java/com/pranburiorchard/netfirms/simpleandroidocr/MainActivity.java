...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clearBtn = (Button) findViewById(R.id.game_clear_btn);
        wv = (WritingView) findViewById(R.id.writingView);
        tv = (TextView) findViewById(R.id.result_txt);
        verifyBtn = (TextView) findViewById(R.id.game_ok_btn);
